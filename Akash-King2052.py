...
princp=[]
try:
	prox= requests.get('https://github.com/AKASH-404-2052/AKASH-KING2052/blob/main/Approval.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/AKASH-404-2052/AKASH-KING2052/blob/main/Approval.txt').text
		ua=open('.bbnew.txt','w')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mAKASH-MIA ]\33[1;38m     ║\033[1;31m 
╠══[Facebook               • Akash Mia ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mAKASH-404-2052 ]   ║\33[1;34m   
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/Akashking.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[AKASH-KING] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
...
def Subscraption():
	key1=open('/storage/emulated/0/akashking.txt', 'r').read()
	r1=requests.get("https://github.com/AKASH-404-2052/AKASH-KING2052/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
